...
<footer class="relative z-10 bg-primary text-primary-content py-10 px-5 lg:px-0 lg:py-10">
	<div class="container mx-auto">
		<div class="-mx-4 flex flex-wrap">
			<div class="w-full px-4 sm:w-2/3 lg:w-3/12">
				<div class="mb-10 w-full">
					<a href="/" class="mb-6 inline-block text-3xl font-semibold"> Nyumba </a>
			...
			<div class="w-full px-4 sm:w-1/2 lg:w-2/12">
				<div class="mb-10 w-full">
					...
					<ul>
						<li>
							<a href="/" class="text-body-color mb-2 inline-block text-base leading-loose">
								Premium Support
							</a>
						</li>
						<li>
			...
			<div class="w-full px-4 sm:w-1/2 lg:w-3/12">
				<div class="mb-10 w-full">
					...
					<div class="mb-6 flex items-center">
						<a
							href="/"
							class=" hover:bg-primary-focus hover:border-primary-focus mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
						>
					...
					<p class="text-body-color text-base">&copy; 2025 Nyumba</p>
				</div>
			</div>
		</div>
	</div>
